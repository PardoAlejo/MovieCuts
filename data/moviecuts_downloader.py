...
if __name__ == "__main__":
    ...
    parser.add_argument('--download_link',   required=True,
                        help = "Link provided to download the data")
